...
import { getCharacters } from "../api/ApiFunction"
    ...
    useEffect(() => {
        ...
        return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                return (
                    <div className="card w-3/4 relative d-flex flex-row justify-center items-center place-self-center">
                    ...
                    <div className="card-description absolute bottom-5 w-full flex flex-col items-center">
                        <div className="w-4/6 bg-yellow-400 shadow-2xl border-4 border-slate-700">
                            <p>Name</p>
                            <p>Description:</p>
                            <p>Comic-scene:</p>
                        </div>
